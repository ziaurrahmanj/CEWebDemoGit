// Type: SageSSO.ServiceReferences.StartExistingUserRegistrationAttemptRequest
...
namespace SageSSO.ServiceReferences
{
  ...
  [DebuggerStepThrough]
  [Serializable]
  public class StartExistingUserRegistrationAttemptRequest
  {
    ...
    private Guid expectedUserIdentityField;
    ...
    [XmlElement(Order = 9)]
    public Guid ExpectedUserIdentity
    {
      get
      {
